...
#include "Halfedge/PolyMeshIterators.h"
#include "Halfedge/MemoryPool.h"
...
//=====================================================================
	...
	MVert* addVertex(double x, double y, double z, double u, double v);
	MVert* addVertex(const Eigen::Vector3d& point, const Eigen::Vector2d& uv);
...
//=====================================================================
	...
	MVert* closestPoint(const Eigen::Vector3d& p);
	double closestPoint(const Eigen::Vector3d& p, MVert* close_v);
...
//=====================================================================
	Eigen::Vector3d calculatFaceCenter(MPolyFace* face);
	Eigen::Vector3d calculatEdgeCenter(MEdge* edge);
